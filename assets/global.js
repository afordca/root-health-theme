...
(function () {
	document.querySelectorAll(".snap-scroll-dot").forEach((anchor) => {
		anchor.addEventListener("click", function (e) {
			...
			if (targetElement) {
				// Assuming your scroll-snap container has an ID like 'horizontal-container'
				const scrollContainer =
					this.parentElement.parentElement.querySelector(".snap-scroll");
				...
				if (scrollContainer) {
					scrollContainer.scrollTo({
						...
						behavior: "smooth", // For smooth scrolling within the container
					});
				}
			}
		});
